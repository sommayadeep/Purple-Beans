...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Simulate luxury skeleton load state (Apple-like progressive hydration)
  ...
  // 1. Loading State: Render Premium Custom Cream/Beige Skeleton system
  if (isLoading) {
    return (
  ...
  return (
    <div className="w-full bg-[#F7F3EE]">
      ...
      >
        ...
        {/* Cinematic dark/cream overlay gradients */}
        ...
        {/* Hero Content (Floating layered parallax text) */}
        <motion.div
        ...
        {/* Ambient Steam/Particle Effect Overlay */}
      ...
      {/* SECTION 2: IMMERSIVE SCROLL EXPERIENCE (Designer.png) */}
      <section
      ...
      <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto space-y-12">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          ...
          >
            Browse All Blends ({PRODUCTS.length})
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {PRODUCTS.map((product) => (
            ...
            >
              ...
              <Link href={`/shop/${product.id}`} className="block relative aspect-square overflow-hidden rounded-sm bg-[#EADFCC]">
                <Image
                  src={product.image}
                  alt={product.name}
                  fill
      ...
      {/* SECTION 4: STORYTELLING SECTION (coffee2.png) */}
