...
// Local minimal types matching database schema
interface Product {
  productId: string;
  name: string;
  price: number;
  ...
  const loadMoreItems = () => {
    ...
    setTimeout(() => {
      ...
      const duplicates = currentList.map((p) => ({
        ...p,
        productId: `${p.productId}-extra-${loadMoreCount}`,
            ...
            >
              <AnimatePresence mode="popLayout">
                {visibleProducts.map((product) => (
                  ...
                  >
                    <Link
                      href={`/shop/${product.productId.split("-extra")[0]}`}
                    ...
                    <div className="mt-6 space-y-2 flex-grow">
                      ...
                      <Link href={`/shop/${product.productId.split("-extra")[0]}`} className="block">
                    ...
                    <div className="mt-6 pt-4 border-t border-[#EADFCC]/50 flex items-center justify-between gap-4">
                      ...
                      <button
                        onClick={() => {
                          // Adapt store structure if needed
                          addItem({
